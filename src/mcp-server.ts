...
const tools = [
  ...
  { name: 'codebone_skeleton', description: 'Get the structural skeleton of a source file or directory. Use mode:"public_api" or symbolsOnly/includeImports/includePrivate/includeRoutes to hide import/private noise and focus classes, functions, routes, app keys, and tables.', inputSchema: schema({ path: 'string', publicOnly: 'boolean', maxFiles: 'integer', budget: 'integer', changedOnly: 'boolean', mode: 'string', symbolsOnly: 'boolean', includeImports: 'boolean', includePrivate: 'boolean', includeRoutes: 'boolean' }, ['path']), outputSchema: outputSchema() },
  ...
  { name: 'codebone_context', description: 'Build a ranked context pack. Use mode:"overview" for human project summary, "composition" for app.py composition root, "architecture" for service graph, or "edit_prep" for minimal edit context and blast radius.', inputSchema: schema({ goal: 'string', path: 'string', budget: 'integer', includeTests: 'boolean', changedOnly: 'boolean', mode: 'string', productionOnly: 'boolean', testsOnly: 'boolean', includeMocks: 'boolean', includeConfig: 'boolean', includeMigrations: 'boolean' }, ['goal']), outputSchema: outputSchema() },
